            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tbody>
                  <?php
                  require_once '../../../backend/aboutus.php';
                  $aboutUS=aboutUS::getAllAboutUs();
                  $counter=1;
                  while($row=$aboutUS->fetch())
                  {
                    ?> 
                    ...
                    <td><form method="post" action="../../../backend/aboutus.php">
                    <input type="hidden" name="id" value="<?php echo $row['id'];?>">
                    <input type="hidden" name="script" value="">
                    <button type="submit" name="submit_delete" class="btn btn-danger">Delete</button>
                    </form></td>
                    <td>
                    <a class="btn btn-primary" href="../forms/update-about.php?id=<?php echo $row['id'];?>">Update</a>
                    </td>
                  </tr>
                  <?php
                  }?>
