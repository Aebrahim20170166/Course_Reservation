              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  while($row=$courses->fetch())
                  {
                    ...
                    <td><form method="post" action="../../../backend/courses.php">
                    <input type="hidden" name="course_id" value="<?php echo $row['id'];?>">
                    <input type="hidden" name="course_image" value="<?php echo $row['image_name'];?>">
                    <input type="hidden" name="script" value="">
                    <button type="submit" name="submit_delete" class="btn btn-danger">Delete</button>
                    </form></td>
                    <td>
                    <a class="btn btn-primary" href="../forms/update-course.php?id=<?php echo $row['id'];?>">Update</a>
                    </td>
                  </tr>
                  <?php
                  }?>
