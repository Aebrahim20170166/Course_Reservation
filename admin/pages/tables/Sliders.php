      ...
      <div class="container-fluid">
        ...
        ?>
            <div class="card">
              ...
              <div class="card-body">
                   <?php
                   require_once '../../../backend/sliders.php';
                  ...
                  <table id="database-table">
                      ...
                      <?php
                      $counter=1;
                      //$path=dirname(__FILE__).'/../admin/pages/upload/';
                      $imagePath="../upload/";
                      //echo $path2;
                      echo "<br>";
                      while($row=$sliders->fetch())
                      {
                        ...
                        <tr>
                          ...
                          <td><img style="width:60px;height:60px" src="<?php echo $imagePath.$row['image_name'];?>"></td>
                          <td>
                          <form method="post" action="../../../backend/sliders.php">
                            <input type="hidden" name="slider_id" value="<?php echo $row['id'];?>">
                            <input type="hidden" name="slider_name" value="<?php echo $row['image_name'];?>">
                            <input type="hidden" name="script" value="">
                            <button type="submit" name="delete_submit" class="btn btn-danger">Delete</button>
                          </form>
                          </td>
                          <td>
                          <a class="btn btn-primary" href="../forms/updateSlider.php?id=<?php echo $row['id'];?>">Update</a>
                          </td>
                      </tr>
                      <?php
                      }
